...
要打开idle-tag-highlight-mode，光标在变量处停留一会，就会把相同的变量
全都高亮，比如下图中的变量mAddr：
...
喜欢，但是在终端下，highlight-edits-mode这个mode让buffer看起来太混乱
了，所以我只在GUI下才启用highlight-edits-mode。
